...
@endsection
@section('title' , trans('library_trans.edit_book'))
@section('page-header')
<!-- breadcrumb -->
                    ...
                    <form method="post" action="{{ route('library.update' , 'test') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" name="title" class="form-control" value="{{ $book->getTranslation('title','ar') }}">
                                @error('title')
                            ...
                            <div class="form-group col">
                                ...
                                <input type="text" name="title_en" class="form-control" value="{{ $book->getTranslation('title','en') }}">
                                @error('title_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
